...
### Step 2b — Start local services

**PostgreSQL (Windows):**
- Ensure it's installed and running (Services → PostgreSQL)
- Or use: `pg_ctl -D "C:\Program Files\PostgreSQL\18\data" start`

**Redis (Windows):**
- Download & extract: https://github.com/tporadowski/redis/releases
...
| Error | Fix |
|-------|-----|
| `ECONNREFUSED 5432` | PostgreSQL not running. Check Services panel or run `pg_ctl start` |
| `ECONNREFUSED 6379` | Redis not running. Extract & run `redis-server.exe` |
